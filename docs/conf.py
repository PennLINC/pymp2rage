...
project = 'pymp2rage'
copyright = '2017, Gilles de Hollander'
...
sys.path.insert(0, os.path.abspath('../pymp2rage'))
...
latex_documents = [
    ('index', 'pymp2rage.tex', 'Pymp2rage Documentation', 'Ariel Rokem', 'manual'),
]
...
man_pages = [('index', 'pymp2rage', 'pymp2rage Documentation', ['Ariel Rokem'], 1)]
